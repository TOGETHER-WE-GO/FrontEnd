...
export const environment = {
  production: false,
  apiUrl: 'http://20.214.110.220:8081',
  exploreurl: 'http://20.214.110.220:8085',
  authorityUrl: 'http://20.214.110.220:8081',
  notificationUrl: 'http://20.214.205.228:8087',
  postUrl: 'http://20.214.205.228:8083',
  clientId: 'together_we_go_angular_client',
  clientUrl: 'https://localhost:4200',
  scope: 'openid profile email roles together_we_go_api.read together_we_go_api.write'
};
